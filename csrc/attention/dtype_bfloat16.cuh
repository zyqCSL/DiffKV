...
inline __device__ float4 to_float(bf16_4_t_ u) {
  float4 f;
  f.x = to_float(u.x);
  f.y = to_float(u.y);
  f.z = to_float(u.z);
...
inline __device__ Float16_ to_float(bf16_16_t u) {
  Float16_ f;
  f.x = to_float(u.x);
  f.y = to_float(u.y);
  f.z = to_float(u.z);
