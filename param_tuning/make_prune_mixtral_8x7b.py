...
prune_threshes = [0.995, 0.999]
quant_threshes = [0.8, 0.85, 0.9, 0.95]

zero_shot_prune_threshes = [0.9995, 0.9999]
zero_shot_quant_threshes = [0.9, 0.95, 0.99]
...
for high_k, high_v, low_k, low_v in quant_configs:
    ...
    for prune_thresh in zero_shot_prune_threshes:
...
prune_threshes = [0.999]
quant_threshes = [0.9, 0.95, 0.99]
...
with open(f'run_prune_mixtral_8x7b.sh', 'w+') as f:
    f.write('\n'.join(cmd_texts))
