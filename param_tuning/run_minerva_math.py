...
def log_llm_stats(dataset: MinervaMathDataset, engine: LLMEngine, log_path: str):
...
def initialize_engine(args: argparse.Namespace) -> LLMEngine:
    ...
    elif 'QwQ' in args.model:
        args.max_model_len = 32 * 1024
...
def main(args: argparse.Namespace):
    ...
    if 'QwQ' in args.model or 'Qwen3' in args.model:
        ...
        batch_size = 128
        prompt_type = 'qwq'
    elif 'Qwen2.5-32B' in args.model:
        max_gen_len = 1024
    else:
        max_gen_len = 1024
