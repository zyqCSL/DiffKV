...
COMMON_TEMPLATE = "--model-gen {} \
--model-size {}  \
--log-path ../logs/new_kernel_param_tune_{}rounds/llama{}-{}b \
--kbits-high {} \
--vbits-high {} \
--kbits-low {} \
--vbits-low {} \
...
prune_threshes = [1.0]
quant_threshes = [0.5, 0.8, 0.85, 0.9, 0.95, 0.99]
...
prune_threshes = [1.0]
quant_threshes = [0.5, 0.8, 0.85, 0.9, 0.95]
...
with open(f'run_compress_llama{MODEL_GEN}_{MODEL_SIZE}b.sh', 'w+') as f:
    f.write('\n'.join(cmd_texts))
