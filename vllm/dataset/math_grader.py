# Copied from https://github.com/QwenLM/Qwen2.5-Math
...
def math_equal(
    ...
    if timeout:
        try:
            if symbolic_equal_timeout(prediction, reference):
                return True
        except Exception as e:
            print('Warning: Timeout error catched in math grader!')
...
def symbolic_equal_timeout(a, b):
