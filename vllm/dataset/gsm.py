...
class GSMQuestion:
    ...
    def update_request_output(self, output: RequestOutput) -> bool:
        ...
        return _is_correct(self.result, self.answer, self.zero_shot)
...
class GSMDataset(LLMDataset):
    def __init__(self):
        super().__init__(LLMDatasetType.COT_QA)
        self.request_to_question: Dict[str, GSMQuestion] = {}
...
class GSM8kDataset(GSMDataset):
    ...
    def sample(
        ...
        for idx in indices:
            ...
            answer = row["answer"]
            questions.append(GSMQuestion(prompt, answer, self.max_tokens, self.zero_shot))
        return questions
