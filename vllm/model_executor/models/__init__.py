...
_MODELS = {
    ...
    # "LlamaForCausalLM": ("llama", "LlamaForCausalLM"),  # depreciated by sparse kv version
    # For decapoda-research/llama-*
    "LLaMAForCausalLM": ("llama", "LlamaForCausalLM"),
    # "MistralForCausalLM": ("mistral", "MistralForCausalLM"),
    # "MixtralForCausalLM": ("mixtral", "MixtralForCausalLM"),
    # "Qwen2ForCausalLM": ("qwen2", "Qwen2ForCausalLM"),
    # Models w. sparse kv caches
    "LlamaForCausalLM": ("sparse_llama", "LlamaForCausalLM"),
    "BaiChuanForCausalLM": ("sparse_baichuan", "BaiChuanForCausalLM"),  # baichuan-7b
    "BaichuanForCausalLM": ("sparse_baichuan", "BaichuanForCausalLM"),
