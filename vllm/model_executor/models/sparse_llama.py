...
class LlamaAttention(nn.Module):
    ...
    # TODO: apply rope here for sparse inputs
    # NOTE: make sure positions do contain index of input tokens
    def forward(
        self,
...
class LlamaModel(nn.Module):
    ...
    def forward(
        ...
        kv_lens: torch.Tensor, shape [batch_size, num_layers, num_heads]
        '''
...
class LlamaForCausalLM(nn.Module):
    ...
    # TODO: make sure that sampler works with prompt output layout
    def sample(
        self,
        hidden_states: torch.Tensor,
