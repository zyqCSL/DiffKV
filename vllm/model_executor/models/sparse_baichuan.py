...
class BaiChuanAttention(nn.Module):
    ...
    def __init__(
        ...
        self.kv_score_thresh = kv_score_thresh
    ...
    def forward(
        ...
        k_cache, v_cache, s_cache, i_cache = kv_cache
        attn_output, kv_len = self.attn(
            query=q,
            key=k,
            value=v,
            key_cache=k_cache,
            value_cache=v_cache,
            score_cache=s_cache,
            position_cache=i_cache,
            input_positions=positions,
            input_metadata=input_metadata,
        )
        output, _ = self.o_proj(attn_output)
        return output, kv_len
...
class BaiChuanDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = BaiChuanAttention(
            ...
            kv_score_thresh=kv_score_thresh,
    ...
    def forward(
        ...
        hidden_states, kv_len = self.self_attn(
            positions=positions,
        ...
        return hidden_states, residual, kv_len
...
class BaiChuanModel(nn.Module):
    ...
    def forward(
        ...
        for layer in self.layers:
            hidden_states, residual, kv_len = layer(
                positions,
                hidden_states,
                kv_caches,
                input_metadata,
        ...
        kv_lens = torch.stack(kv_lens, dim=1)
        return hidden_states, kv_lens
...
class BaiChuanBaseForCausalLM(nn.Module):
    ...
    def forward(
        ...
        hidden_states, kv_lens = self.model(input_ids, positions, kv_caches,
                                   input_metadata)
        return hidden_states, kv_lens
